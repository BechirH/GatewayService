...
@Component
public class SafeDedupeResponseHeaderFilter extends AbstractGatewayFilterFactory<SafeDedupeResponseHeaderFilter.Config> {

    private static final Logger logger = LoggerFactory.getLogger(SafeDedupeResponseHeaderFilter.class);
    private final DedupeResponseHeaderGatewayFilterFactory dedupeFilterFactory;

    public SafeDedupeResponseHeaderFilter(DedupeResponseHeaderGatewayFilterFactory dedupeFilterFactory) {
        super(Config.class);
